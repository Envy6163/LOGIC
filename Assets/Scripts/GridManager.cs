...
public class GridManager : MonoBehaviour
{
    ...
    public void RemoveAllUserPlacedComponentsAndWires()
    {
        foreach(var item in FindObjectsOfType<PrefabInfo>())
        {
            NewComponent component = item.GetComponent<NewComponent>();
            NewWire wire = item.GetComponent<NewWire>();
            if (component != null)
            {
